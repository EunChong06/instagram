		...
		<div className="col-12">
			<div className="row">
				...
				<div className="col-8 mt-3">
					<div className="row">
						<div className="col-5 text-center" style={{borderLeft:"1px solid", borderTop:"1px solid", borderBottom:"1px solid"}}>
						...
						<div className="col-5" style={{borderLeft: "1px solid", borderBottom: "1px solid", height: "450px"}}>
							<div className="row my-3">
								<div className="col-12" style={{backgroundColor: "#edebeb", borderRadius: "10px"}}>
									<div className="row my-2">
										...
										<div className="col-10"> Kim Eun Chong <br></br><small>hellow * 49 мин</small></div>
									</div>
								</div>
							</div>
						</div>
						<div className="col-7" style={{borderLeft: "1px solid", borderBottom: "1px solid", borderRight: "1px solid"}}>
							<div className="row my-3">
								<div className="col-12">
									<div className="row">
										<div className="col-9"></div>
										<div className="col-2 text-center ms-2" style={{backgroundColor: "#ab7df5", borderRadius: "10px"}}>Hellow</div>	
									</div>
								</div>
								<div className="col-12">
									<div className="row">
										<div className="col-2 text-center ms-2" style={{backgroundColor: "#ab7df5", borderRadius: "10px"}}>Hi</div>
										<div className="col-9"></div>
									</div>
								</div>
							</div>
						</div>
							<div className="col-4" style={{position: "fixed", top: "500px", left: "580px" ,border:"1px solid", borderRadius: "10px"}}>
								<div className="row my-3">
									<div className="col-1 mt-2"><h5><i className="fa-solid fa-face-smile"></i></h5></div>
									<div className="col-5"><input id="text" className="form-control" type="" name="" placeholder="напишите сообщение..."></input></div>
									<div className="col-3">
										<button className="bg-info form-control">send</button>
									</div>
									<div className="col-1 mt-2"><h5><i className="fa-solid fa-image"></i></h5></div>
									<div className="col-1 mr-3 mt-2"><h5><i className="fa-solid fa-heart"></i></h5></div>
								</div>
							</div>
						</div>
					</div>
